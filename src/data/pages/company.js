export const page = {
  ...
  whatIs: {
    title: "About Accern",
    description: "Accern accelerates AI workflows for financial service enterprises with a no-code AI platform. The best data teams from the world's leading organizations, such as Allianz, IBM, and Jefferies, are using Accern to build and deploy AI use cases powered by our adaptive NLP and forecasting features.",
    img: "what-is-accern.png",
    keyHighlights: {
      ...
      columns: [
        ...
        { title: "40+", description: "Data-driven Employees", className: "pt-3 pb-3 pl-4 pr-4" },
  ...
  brands: {
    ...
    columns: [
      ...
      { logo: "logo-ibm.png", className: "preset-img-5" },
  ...
  media: {
    ...
    columns: [
      ...
      { logo: "fortune-logo.png", className: "icon-carousel-2", link:{link: "#"}},
    ]
  },
  ...
  awards: {
    ...
    className: "pt-0 pb-0",
    columns: [
      { title: "Forbes 30 Under 30", description: "Enterprise Tech", img: "forbes-img.png", link: "https://www.forbes.com/30-under-30/2018/enterprise-technology/#668451d2551c"},
      { title: "Top 10 AI Software", description: "O’Reilly and Intel AI", img: "oreilly-logo.png", link: "https://conferences.oreilly.com/%rtifici%l-intelligence/ai-ca-2018/public/schedule/detail/71437"},
      { title: "Best Data Analysis", description: "Benzinga FinTech Awards", img: "benzinga-logo.png", link: "https://www.benzinga.com/events/fintech-awards/listmakers/"},
      { title: "Top Text Parser", description: "J.P.Morgan", img: "morgan-logo.png", link: "https://www.cfasociety.org/cleveland/Lists/Eventsa20Calendar/Attachments/1045/BIG-Data_AI-JPMmay2017.pdf"},
      { title: "100 Best Places to Work", description: "Crain's NY 2020", img: "cnyb_logo_illus5_2015redesign_black.png", link: "https://www.crainsnewyork.com/best-places-work/introducing-crains-100-best-places-work-2020"},
      { title: "Top No-Code Startup", description: "AI & Data Science", img: "substack-logo.png", link: "https://alexandre.substack.com/p/-no-code-unleashing-creativity-on"},
      { title: "2020 InsurTech 100", description: "FinTech Global", img: "fintech-global-logo.png", link: "https://fintech.global/insurtech100/"},
      { title: "2020 Top 25 FinTech CTO", description: "FT Report", img: "financial-report-logo.png", link: "https://thefinancialtechnologyreport.com/top-25-financial-technology-ctos-of-2020/"},
      { title: "2020 Top 50 FinTech CEO", description: "FT Report", img: "financial-report-logo.png", link: "https://thefinancialtechnologyreport.com/the-top-50-financial-technology-ceos-of-2020/"},
      { title: "2020 Top 10 Coolest AI Startups", description: "CRN", img: "crn-logo.png", link: "https://www.crn.com/slide-shows/mobility/the-10-coolest-ai-startups-of-2020-so-far-/2"},
    ]
  },

  weAccelerating: {
    title: "We accelerate AI for financial services with a no-code AI platform.",
    titleCL: "mw-700",
  ...
  cover: {
    img: "careers-office-2.jpg",
    variant: "dark",
    title: "Our Mission",
    description: "Our mission is to accelerate innovation for enterprises by democratizing AI with a no-code platform.",
    className: "mb-spacer"
  },
