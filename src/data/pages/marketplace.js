export const page = {
  ...
  useCases: {
    ...
    industries: {
      ...
      options: [
        { label: "All", value: "All" },
        { label: "Asset Management", value: "Asset Management", description: "AI use cases built for Asset Management.", img: "spec-icon-settings.svg" },
        { label: "Banks", value: "Banks", description: "AI use cases built for Banking", img: "spec-icon-bank.svg"},
        { label: "Insurance", value: "Insurance", description: "AI use cases built for Insurance.", img: "spec-icon-shield.svg" },
      ]
    },
    workflows: {
    ...
    solutions: {
      ...
      options: [
        { label: "All", value: "All" },
        { label: "Claims Management", value: "Claims Management", description: "AI use cases built for", img: "solution-icon-14.svg" },
        { label: "Credit Risk", value: "Credit Risk", description: "AI use cases built for", img: "solution-icon-11.svg" },
        { label: "Customer Experience", value: "Customer Experience", description: "AI use cases built for", img: "solution-icon-9.svg" },
        { label: "Customer Retention", value: "Customer Retention", description: "AI use cases built for", img: "solution-icon-8.svg" },
        { label: "Equity Research", value: "Equity Research", description: "AI use cases built for", img: "solution-icon-12.svg" },
        { label: "ESG Investing", value: "ESG Investing", description: "AI use cases built for", img: "solution-icon-3.svg" },
        { label: "Event-Driven Investing", value: "Event-Driven Investing", description: "AI use cases built for", img: "solution-icon-2.svg" },
        { label: "Financial Crimes", value: "Financial Crimes", description: "AI use cases built for", img: "solution-icon-7.svg" },
        { label: "Fundamental Research", value: "Fundamental Research", description: "AI use cases built for", img: "solution-icon-6.svg" },
        { label: "Long/Short Equity", value: "Long/Short Equity", description: "AI use cases built for", img: "solution-icon-5.svg" },
        { label: "Merger Arbitrage", value: "Merger Arbitrage", description: "AI use cases built for", img: "solution-icon-4.svg" },
        { label: "Mergers & Acquisitions", value: "Mergers & Acquisitions", description: "AI use cases built for", img: "solution-icon-13.svg" },
        { label: "Product Recommendations", value: "Product Recommendations", description: "AI use cases built for", img: "solution-icon-10.svg" },
        { label: "Quantitative Research", value: "Quantitative Research", description: "AI use cases built for", img: "solution-icon-1.svg" },
        { label: "Underwriting", value: "Underwriting", description: "AI use cases built for", img: "solution-icon-1.svg" },
      ]
    },
    list: [
      {
