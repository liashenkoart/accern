export const page = {
  hero: {
    label: "Accern's Smart Insights",
    title: "<strong>Generate Alternative Insights to Enhance</strong> Decisions with Smart Insights",
    titleCL: "mw-800",
    className: "mt-5",
    variant: "primary",
  }, 
    ...
    rows: [
      {
        ...
        title: "Obtain Derived Analytics",
        description: "Consolidate large documents from multiple sources into shorter and more digestible insights for quick knowledge consumption.",
        img: "wealth-management-img-1.svg",
      },
      {
        label: "WORKFLOW STEP 02",
        labelCL: "text-primary",
        title: "Export Insights into External Applications",
        description: "Seamlessly export your smart insights into visualization dashboards, CMS systems, predictive modeling tools, and more.",
        img: "wealth-management-img-2.svg",
      },
      {
  ...
  whitepaper: {
    ...
    isDisableShape: true,
    title: "Deploy Smart Insights AI Use Cases 75x faster for Financial Service",
    className: "mb-s",
    titleCL: "mw-800",
    labelCL: "op-05",
