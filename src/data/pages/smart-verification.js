export const page = {
  hero: {
    label: "Accern's Smart Verification",
    title: "<strong>Verify the Validity of a Customer’s Claim</strong> with Smart Verification",
    titleCL: "mw-800",
    className: "mt-5",
    variant: "danger",
  }, 
    ...
    rows: [
      {
        ...
        title: "Obtain Insights into a Customer’s Claim",
        description: "Identify if a customer’s claim is valid to enhance claims management processes.",
  ...
  whitepaper: {
    ...
    isDisableShape: true,
    title: "Deploy Smart Verification AI Use Cases 75x faster for Financial Services",
    className: "mb-s",
    titleCL: "mw-800",
    labelCL: "op-05",
