export const page = {
  hero: {
    ...
    title: "3 ways Accern is helping to solve <strong>Developers</strong> problem",
    titleCL: "mw-800",
    variant: "lines",
    theme: "orange",
  ...
  dataEngineers: {
    ...
    rows: [
      {
        label: "Developers",
        title: "What is a <span class='text-special-primary-dark'>Developers</span> and what are they responsible for?",
        titleCL: "mw-600",
  ...
  features: {
    ...
    rows: [
      {
        label: "Problem",
        title: "What <span class='text-special-primary-dark'>problem</span> are <span class='text-special-primary-dark'>Developers</span> facing?",
        titleCL: "mw-800",
      ...
      {
        label: "Solution",
        title: "3 ways Accern is helping to solve <span class='text-special-primary-dark'>Developers</span> problem",
        titleCL: "mw-650",
