export const page = {
  hero: {
    label: "Accern's Smart Recommendations",
    title: "<strong>Generate Auto-Recommended Answers</strong> to Customers’ Questions with Smart Recommendations",
    titleCL: "mw-800",
    className: "mt-5",
    variant: "light",
  }, 
    ...
    rows: [
      {
        ...
        title: "Obtain insights on customer FAQs",
        description: "Identify customer FAQs and the answers to auto-recommend answers through a chatbot.",
        img: "wealth-management-img-1.svg",
      },
      {
        label: "WORKFLOW STEP 02",
        labelCL: "text-primary",
        title: "Export Insights into Chatbot Applications",
        description: "Seamlessly export your customer FAQ insights into chatbots to enhance customer experience.",
        img: "wealth-management-img-2.svg",
      },
    ]
  },
  ...
  whitepaper: {
    ...
    isDisableShape: true,
    title: "Deploy Smart Recommendations AI Use Cases 75x faster for Financial Services",
    className: "mb-s",
    titleCL: "mw-800",
    labelCL: "op-05",
