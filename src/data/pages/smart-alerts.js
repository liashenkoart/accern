export const page = {
  hero: {
    label: "Accern's Smart Alerts",
    title: "<strong>Monitor Important Events with</strong> Automated Notifications",
    titleCL: "mw-800",
    className: "mt-5",
    variant: "advanced",
  }, 
  ...
  features: {
    ...
    rows: [
      ...
      },
      {
        ...
        labelCL: "text-primary",
        title: "Integrate Alerts into Your Workflows",
        description: "Integrate smart alerts into news platforms, widgets, and excel models, or deliver them via email, SMS, chat, browser, and more for a flexible real-time notification delivery.",
        img: "wealth-management-img-2.svg",
      },
      {
        label: "WORKFLOW STEP 03",
        labelCL: "text-primary",
        title: "Edit and Expand Smart Alerts Use Cases",
        description: "Scale your use of Accern’s Smart Alerts use cases with additional data sources, taxonomy, and adaptive NLP models.",
  ...
  whitepaper: {
    ...
    isDisableShape: true,
    title: "Deploy Smart Alerts AI Use Cases 75x faster for Financial Services",
    className: "mb-s",
    titleCL: "mw-800",
    labelCL: "op-05",
